...
const PredictorPage = () => {
    ...
    return (
      <div className="flex flex-col gap-y-8 justify-center items-center w-full p-10">
        ...
        <Container title="Marque du véhicule" className={CONTAINER_CLASSES}>
            ...
            {carNames?.map((car: CarNameInterface, index: number) => (
              <Card
                ...
                className={cn(
                  ...
                  isSelectedBrand(car.brand) &&
                    'bg-blue-500/50 dark:bg-blue-500/90'
                )}
              >
                <CardHeader>
        ...
        <Container title="Année du véhicule" className={CONTAINER_CLASSES}>
          <Input
            type="number"
            min="1900"
            placeholder="2023"
            value={data.year}
            onChange={(e) => handleUpdateData('year', parseInt(e.target.value))}
          />
        </Container>
        {/* <Container
        ...
        >
          <Input
            ...
            value={data.mileage}
            onChange={(e) =>
              handleUpdateData('mileage', parseInt(e.target.value))
            }
          />
        </Container>
        <Container title="Type d'essence" className={CONTAINER_CLASSES}>
          <Select
            value={data.fuel_type}
            onValueChange={(v) => handleUpdateData('fuel_type', v)}
          >
            <SelectTrigger>
        ...
        <Container title="Type de transmission" className={CONTAINER_CLASSES}>
          <Select
            value={data.transmission}
            onValueChange={(v) => handleUpdateData('transmission', v)}
          >
            <SelectTrigger>
            ...
            <SelectContent>
              {transmissions?.map((transmission, index) => (
                <SelectItem key={index} value={transmission}>
                  {transmission}
                </SelectItem>
              ))}
            </SelectContent>
        ...
        <Container title="Nombre de chevaux" className={CONTAINER_CLASSES}>
          <Input
            type="number"
            min="0"
            value={data.power}
            onChange={(e) =>
              handleUpdateData('power', parseInt(e.target.value))
            }
          />
        </Container>

        <Container title="Nombre de portes" className={CONTAINER_CLASSES}>
          <Input
            type="number"
            min="0"
            value={data.num_doors}
            onChange={(e) =>
              handleUpdateData('num_doors', parseInt(e.target.value))
            }
          />
        </Container>

        <Container title="Nombre de places" className={CONTAINER_CLASSES}>
          <Input
            type="number"
            min="0"
            value={data.num_seats}
            onChange={(e) =>
              handleUpdateData('num_seats', parseInt(e.target.value))
            }
          />
        </Container>

        <Container title="Emission de CO2" className={CONTAINER_CLASSES}>
          <Input
            type="number"
            min="0"
            value={data.co2_emission}
            onChange={(e) =>
              handleUpdateData('co2_emission', parseInt(e.target.value))
            }
          />
        </Container>

        <Container title="Longueur" className={CONTAINER_CLASSES}>
          <Input
            type="number"
            min="0"
            value={data.length}
            onChange={(e) =>
              handleUpdateData('length', parseInt(e.target.value))
            }
          />
        </Container>

        <Container title="Note crit'air" className={CONTAINER_CLASSES}>
          <Input
            type="number"
            min="0"
            value={data.critair_rating}
            onChange={(e) =>
              handleUpdateData('critair_rating', parseInt(e.target.value))
            }
          />
        </Container>

        <Container title="Consommation combinée" className={CONTAINER_CLASSES}>
          <Input
            type="number"
            value={data.combined_consumption}
            onChange={(e) =>
              handleUpdateData('combined_consumption', parseInt(e.target.value))
            }
          />
        </Container>
        ...
        >
          <div className="items-top flex flex-col gap-4">
            ...
            <input
              ...
              id="origin"
              checked={data.origin}
              onChange={() => handleUpdateData('origin', !data.origin)}
            />
          </div>
          <div className="items-top flex flex-col gap-4">
            <div className="grid gap-1.5 leading-none">
              ...
              <p className="text-sm text-muted-foreground">
                Cocher cette case si le véhicule a passé son entretien
                technique.
              </p>
            </div>
            <input
              ...
              checked={data.technical_inspection}
              onChange={() =>
                handleUpdateData(
                  'technical_inspection',
                  !data.technical_inspection
                )
              }
            />
          </div>
          <div className="items-top flex flex-col gap-4">
            ...
            <input
              ...
              type="checkbox"
              id="first_hand"
              checked={data.first_hand}
              onChange={() => handleUpdateData('first_hand', !data.first_hand)}
            />
          </div>
        </Container>
